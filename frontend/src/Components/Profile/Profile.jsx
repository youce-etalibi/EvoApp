...
export default function Profile() {
  ...
  const { setuser_id, user_id, user_db, setuserisauth } =
      ...
      {user ? (
        ...
        >
          <IconButton onClick={handleClick} size="small" sx={{ p: 1 }}>
            <Avatar sx={{ width: 30, height: 30,  mr: 1}}>M</Avatar>
            <Typography variant="h6" sx={{ fontSize: '1rem', color: 'white', fontWeight:'500' }}>
                {user_db.name}
            </Typography>
          </IconButton>
        </Box>
